...
xcopy /E %TS_SRC_ROOT%\%SALMON_CORE% %JS_OUTPUT_DIR%\%JS_SALMON_CORE_PACKAGE_NAME%\%SALMON_CORE%
...
xcopy /E %TS_SRC_ROOT%\%SALMON_FS% %JS_OUTPUT_DIR%\%JS_SALMON_FS_PACKAGE_NAME%\%SALMON_FS%
