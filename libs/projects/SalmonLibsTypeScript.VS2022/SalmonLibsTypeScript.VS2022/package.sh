...
cp ../README.txt $PACKAGES_DIR/$TS_SALMON_CORE_PACKAGE_NAME
...
cp ../README.txt $PACKAGES_DIR/$TS_SALMON_FS_PACKAGE_NAME
...
cp ../README.txt $PACKAGES_DIR/$JS_SALMON_CORE_PACKAGE_NAME
...
cp ../README.txt $PACKAGES_DIR/$JS_SALMON_FS_PACKAGE_NAME
