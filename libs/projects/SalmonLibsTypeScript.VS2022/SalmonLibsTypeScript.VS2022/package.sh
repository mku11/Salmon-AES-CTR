...
cp Salmon.Core.README.txt $PACKAGES_DIR/$TS_SALMON_CORE_PACKAGE_NAME/README.txt
...
cp Salmon.FS.README.txt $PACKAGES_DIR/$TS_SALMON_FS_PACKAGE_NAME/README.txt
...
cp Salmon.Core.README.txt $PACKAGES_DIR/$JS_SALMON_CORE_PACKAGE_NAME/README.txt
...
cp Salmon.FS.README.txt $PACKAGES_DIR/$JS_SALMON_FS_PACKAGE_NAME/README.txt
